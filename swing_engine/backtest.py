...
def _snapshot_row_from_packet(packet: dict, regime: dict, evaluation_date: str, replay_mode: str) -> dict:
    ...
    snapshot.update({
        ...
        "structure_score_composite": production.get("structure_score"),
        ...
        "atr_ratio": production.get("atr_ratio"),
        "expansion_quality": production.get("expansion_quality"),
        "rsi_14": breakout_features.get("rsi", {}).get("rsi_14"),
        "rsi_bucket": breakout_features.get("rsi", {}).get("rsi_bucket"),
        "rsi_trend": breakout_features.get("rsi", {}).get("rsi_trend"),
        "avwap_effect_on_decision": production.get("avwap_effect_on_decision"),
        ...
        "active_avwap_anchors": list(avwap.get("active_anchors", [])),
