...
DAILY_IMPORTS_DIR = IMPORTS_DIR / "daily"
...
for _path in (DATA_DIR, CACHE_DIR, IMPORTS_DIR, DAILY_IMPORTS_DIR, REPORTS_DIR, RESEARCH_REPORTS_DIR, TEMPLATES_DIR, CHARTS_OUTPUT_DIR, DOCS_DIR):
...
WATCHLIST = [
    ...
    "NBIS", "BRUN", "POET", "LGCY", "MWH", "FPS", "SPIR", "ETON", "TGEN", "MRVL",
    "PL", "BKSY", "RKLB", "RDW", "ACLS", "AMPX", "AMSC", "UMC", "PLPC", "AIP",
    "INVE", "MX", "CVV", "ATOM", "SVCO", "VELO", "HTLD", "TSM",
    "TSLA", "AMD", "INTC", "SBGI", "TRIP", "M", "META", "JPM", "V", "MA",
    "CAT", "GE", "HON", "UNP", "LLY", "COST", "XOM", "CVX",
]
...
BACKTEST_HISTORY_BUFFER_DAYS = 365
